...
import il.co.runnerdevice.AlertDialogManager;
...
public class LoginDisplayActivity  extends Activity  {
	// Email, password edittext
	        ...
	        btnLogin.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View arg0) {
					...
					//	new LoginRunner(username.trim(),password.trim(),session).execute();
						...
						alert.showAlertDialog(LoginDisplayActivity.this, "Login failed..", "Please enter username and password", false);
					}
				}
			});
	    }
		...
		void setLogin(SessionService session,String username,String password) {
	        ...
	        .build();
			 _dialog = ProgressDialog.show(LoginDisplayActivity.this, "נא המתן", "נא המתן שיתבצע התהליך", true, false);
		     ...
		     call.enqueue(new Callback<AccessToken>() { 
					...
					public void onFailure(Call<AccessToken> arg0, Throwable arg1) {
						...
						_dialog.dismiss();
						alert.showAlertDialog(LoginDisplayActivity.this, "Login failed..", "Error Ocuur", false);
