 ...
 * https://github.com/Udinic/AccountAuthenticator/blob/master/src/com/udinic/accounts_authenticator_example/authentication/AuthenticatorActivity.java
...
public class AuthenticatorActivity extends AccountAuthenticatorActivity {
    ...
    public void submit() {
        ...
        .build();
		 _dialog = ProgressDialog.show(AuthenticatorActivity.this, "נא המתן", "נא המתן שיתבצע התהליך", true, false);
	     
        final String accountType = getIntent().getStringExtra(ARG_ACCOUNT_TYPE);
       
        ShipApi service = retrofit.create(ShipApi.class);
	     Call<AccessToken> call = service.Login(userName, userPass, AccountGeneral.CLIENT_ID, AccountGeneral.GRANT_TYPE_PWS);
	    	 ...
	    	 final Intent res = new Intent();
				...
				public void onFailure(Call<AccessToken> arg0, Throwable arg1) {
					Bundle data = new Bundle();
					 ...
					 res.putExtras(data);
					 _dialog.dismiss();
					 alert.showAlertDialog(AuthenticatorActivity.this, "Login failed..", "Error Ocuur", false);
					 finishLogin(res) ;
				}
				@Override
    ...
    public void finishLogin(Intent intent) {
        ...
        if (getIntent().getBooleanExtra(ARG_IS_ADDING_NEW_ACCOUNT, false)) {
            ...
            String expiredDate = intent.getStringExtra(AccountGeneral.PARAM_EXPIRED);
            ...
            Log.d("runnerdevice", TAG + "> finishLogin > setPassword");
