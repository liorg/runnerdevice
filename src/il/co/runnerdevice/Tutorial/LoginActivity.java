...
public class LoginActivity extends Activity {
		...
		btnLogin.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				if (username.trim().length() > 0
					...
					new LoginRunner(username.trim(), password.trim(), session)
							.execute();
	...
	public class LoginRunner extends AsyncTask<Void, Void, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			_dialog = ProgressDialog.show(LoginActivity.this, "נא המתן",
		...
		protected String doInBackground(Void... params) {
			String text = null;
			String token = "";
			List<NameValuePair> nameValuePairs = CustomHttpClient.GetLoginData(
					_user, _pws);
			...
			try {
				...
				text = CustomHttpClient.GetASCIIContentFromEntity(response
						.getEntity());
		...
		protected void onPostExecute(String results) {
			...
			try {
				...
				if (_access_token.has("error")) {
					...
					errDesc = _access_token.has("error_description") ? _access_token
							.getString("error_description") : "error occur!!!";
					alert.showAlertDialog(LoginActivity.this, "Login failed..",
							errDesc, false);
				} else {
					String token = _access_token.getString("access_token");
					String refresh_token = _access_token
							.getString("refresh_token");
					String userName = _access_token.getString("userName");
					String currentTime = _access_token
					...
					// createLoginSession(String name, String refresh,String
					// currentdate,String expireddate,String token,String roles)
