...
public class Token_Fragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		rootView = inflater.inflate(R.layout.token_fragment, container, false);

		m_session = new SessionManager(getActivity().getApplicationContext());

		Toast.makeText(getActivity().getApplicationContext(),
				"User Login Status: " + m_session.isLoggedIn(),
		...
		TextView lblRefresh = (TextView) rootView
				.findViewById(R.id.lblRefreshToken);
		...
		lblRefresh.setText(Html.fromHtml("Refresh Token: <b>" + refresh
				+ "</b>"));
		// lblCdate.setText(Html.fromHtml("Current Date: <b>" + cdate +
		// "</b>"));
		// lblCdate.setText(Html.fromHtml("Expired Date: <b>" + edate +
		// "</b>"));
		...
		btnRegister.setOnClickListener(new View.OnClickListener() {
			...
			@Override
			public void onClick(View arg0) {
				final String regId = GCMRegistrar.getRegistrationId(rootView
						.getContext());
				if (regId.equals("")) {
